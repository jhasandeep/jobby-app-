...
- Wrap the `Loader` component with an HTML container element and add the `tesid` attribute value as **loader** to it

  ```jsx
  <div className="loader-container" tesid="loader">
...
- **Jobs Route**
  ...
  - The HTML button element with search icon should have the `tesid` attribute value as **searchButton** to it

  ```jsx
  <button type="button" tesid="searchButton">
